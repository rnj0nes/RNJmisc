#' Effect Size for Pre-Post Designs with Control Group
#'
#' Computes effect size for a two-group pre-post design by calculating
#' the net effect (treatment minus control difference scores) standardized
#' by pooled baseline standard deviation.
#'
#' @param m01 Control group mean at baseline
#' @param m02 Control group mean at follow-up
#' @param m11 Treatment group mean at baseline
#' @param m12 Treatment group mean at follow-up
#' @param sd0 Control group SD at baseline
#' @param sd1 Treatment group SD at baseline
#' @param n0 Control group sample size
#' @param n1 Treatment group sample size
#'
#' @return The standardized effect size of the net effect
#'
#' @examples
#' esiDneteffect(56.6, 46.0, 55.1, 51.0, 14.2, 9.1, 19, 11)
#'
#' @export
